...
wp.blocks.registerBlockType("zozuk/wpmarathi", {
  title: "WPMarathi",
  icon: React.createElement("span", {
    class: "wpmarathi-logo"
  }),
  category: "common",
    ...
    from: [
        {
            ...
            transform: function ( attributes ) {
                return wp.blocks.createBlock( 'zozuk/wpmarathi', {
...
class HindiEditor extends React.Component {
        ...
        onChange: function(content) {
          ...
          if (isEnter) {
            ...
            contentArray.forEach((content,index)=>{
              ...
              const WPMarathiBlock = wp.blocks.createBlock('zozuk/wpmarathi',{content});
  ...
  toggleButton() {
    ...
    return React.createElement(
      "button",
      {
        className: "wpmarathi-block-editor-button active",
...
jQuery("body").on("keydown", ".wp-block-zozuk-wpmarathi", function(e) {
  if (e.key == "Enter") {
    isEnter = true;
  } else {
    isEnter = false;
